...
int check_ompf_omp_get_num_threads(FILE * logfile);  /* Test for omp_get_num_threads */
int crosscheck_ompf_omp_get_num_threads(FILE * logfile);  /* Crosstest for omp_get_num_threads */
int check_ompf_omp_get_wtick(FILE * logfile);  /* Test for omp_get_wtick */
int crosscheck_ompf_omp_get_wtick(FILE * logfile);  /* Crosstest for omp_get_wtick */
int check_ompf_omp_get_wtime(FILE * logfile);  /* Test for omp_get_wtime */
int crosscheck_ompf_omp_get_wtime(FILE * logfile);  /* Crosstest for omp_get_wtime */
int check_ompf_omp_in_parallel(FILE * logfile);  /* Test for omp_in_parallel */
int crosscheck_ompf_omp_in_parallel(FILE * logfile);  /* Crosstest for omp_in_parallel */
int check_ompf_omp_lock(FILE * logfile);  /* Test for omp_lock */
int crosscheck_ompf_omp_lock(FILE * logfile);  /* Crosstest for omp_lock */
int check_omp_master(FILE * logfile);  /* Test for omp master */
int crosscheck_omp_master(FILE * logfile);  /* Crosstest for omp master */
int check_ompf_omp_nest_lock(FILE * logfile);  /* Test for omp_nest_lock */
int crosscheck_ompf_omp_nest_lock(FILE * logfile);  /* Crosstest for omp_nest_lock */
...
int check_parallel_for_firstprivate(FILE * logfile);  /* Test for omp parallel for firstprivate */
int crosscheck_parallel_for_firstprivate(FILE * logfile);  /* Crosstest for omp parallel for firstprivate */
int check_parallel_for_lastprivate(FILE * logfile);  /* Test for omp parallel for lastprivate */
int crosscheck_parallel_for_lastprivate(FILE * logfile);  /* Crosstest for omp parallel for lastprivate */
...
int check_parallel_for_private(FILE * logfile);  /* Test for omp parallel for private */
int crosscheck_parallel_for_private(FILE * logfile);  /* Crosstest for omp parallel for private */
...
int check_parallel_sections_firstprivate(FILE * logfile);  /* Test for omp parallel sections firstprivate */
int crosscheck_parallel_sections_firstprivate(FILE * logfile);  /* Crosstest for omp parallel sections firstprivate */
int check_parallel_sections_lastprivate(FILE * logfile);  /* Test for omp parallel sections lastprivate */
int crosscheck_parallel_sections_lastprivate(FILE * logfile);  /* Crosstest for omp parallel sections lastprivate */
int check_parallel_sections_private(FILE * logfile);  /* Test for omp parallel sections private */
int crosscheck_parallel_sections_private(FILE * logfile);  /* Crosstest for omp parallel sections private */
...
int check_ompf_omp_test_lock(FILE * logfile);  /* Test for omp_test_lock */
int crosscheck_ompf_omp_test_lock(FILE * logfile);  /* Crosstest for omp_test_lock */
int check_ompf_omp_test_nest_lock(FILE * logfile);  /* Test for omp_test_nest_lock */
int crosscheck_ompf_omp_test_nest_lock(FILE * logfile);  /* Crosstest for omp_test_nest_lock */
