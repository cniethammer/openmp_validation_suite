...
int <ompts:testcode:functionname>ompf_omp_lock</ompts:testcode:functionname>(FILE * logFile)
{
  omp_lock_t lck;
...
#pragma omp parallel shared(lck)
  {
    ...
    for(i=0;i<LOOPCOUNT;i++)
      {
	<ompts:check>omp_set_lock(&lck);</ompts:check><ompts:crosscheck></ompts:crosscheck>
#pragma omp flush
...
#pragma omp flush           
	...
	<ompts:check>omp_unset_lock(&lck);</ompts:check><ompts:crosscheck></ompts:crosscheck>
      }
  }
